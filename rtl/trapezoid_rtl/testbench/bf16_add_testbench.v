...
// Tests the BF16 floating-point addition pipeline module
`timescale 1ns/1ps
...
module bf16_add_testbench;
    ...
    // Test sequence
    initial begin
        $dumpfile("bf16_add_test.vcd");
        $dumpvars(0, bf16_add_testbench);
        ...
        $display("==== BF16 Addition Pipeline Testbench ====");
        $display("Clock period: %d ns", CLK_PERIOD);
        $display("");

        // Test cases
        run_test(16'h3F80, 16'h3F80, 16'h4000, "1.0 + 1.0 = 2.0");
        run_test(16'h0000, 16'h3F80, 16'h3F80, "0.0 + 1.0 = 1.0");
        run_test(16'h3F80, 16'hBF80, 16'h0000, "1.0 + (-1.0) = 0.0");
        run_test(16'h3F00, 16'h3F00, 16'h3F80, "0.5 + 0.5 = 1.0");
        run_test(16'h4000, 16'h4080, 16'h4140, "2.0 + 4.0 = 6.0");
        run_test(16'h3F80, 16'h0000, 16'h3F80, "1.0 + 0.0 = 1.0");
        run_test(16'hBF80, 16'hBF80, 16'hC000, "(-1.0) + (-1.0) = -2.0");
        run_test(16'h3E80, 16'h3E80, 16'h3F00, "0.25 + 0.25 = 0.5");
